		...
		<table class="table " >
		    ...
		    <tbody>
		      ...
		      <tr>
		      	...
		      	<td><label class="label label-default"><?php echo e($usuario->id); ?></label></td>
		        ...
		        <td style="text-align: center"><a href="<?php echo e(route('usuario.editar',$usuario->id)); ?>" class="btn btn-warning"> <span class="glyphicon glyphicon-edit"></span> Editar</a>
		        
		        <a href="<?php echo e(route('usuario.eliminar',$usuario->id)); ?>" onclick="return confirm('¿Está seguro de eliminar el usuario definitivamente?')" class="btn btn-danger action"> <span class="glyphicon glyphicon-trash"></span>Eliminar</a>
				</td>
		      </tr>
		    ...
		    <div class="modal-dialog">
		      ...
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
		        	...
		        	<form class="form-horizontal" method="post" action="<?php echo e(route('usuario.crear')); ?>">
		        		<?php echo csrf_field(); ?>
